...
var audioPath = "pages/audio/Topic01/T01P28/T01P28";
...
function fnOnAudioComplete() {
    ...
    if (gAudioId == "startAudio") {
        ...
        $('.small_expand2').css('display', 'block').css('opacity', '1');
        $('.boxInst').show()
        audplayer.pause();
...
$(".small_expand").off().on("click", function() {
    ...
    $('.modalContent').removeClass('maxBot1');
});
...
$(".small_expand2").off().on("click", function() {
