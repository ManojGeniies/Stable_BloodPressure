...
manifest = [{
	src: 'pages/images/Topic01/T01P40/Mask_Group_11.png',
	id: '1'
}, ];
glossaryFuncPageLevel();

var audioPath = "pages/audio/Topic01/T01P40/undefined";
var gItemAudioPath = ["pages/audio/Topic01/T01P40/T01P40_1", "pages/audio/Topic01/T01P40/T01P40_2"];
...
$(document).ready(function() {
	...
	$("#ClsbackImg2").hide()
	$("#subTxt3").hide();
	var n = isInArray("M1L0T1P40", gCompPageArr);
	if (n == true) {
		enableNextBtn();
		// fnGlowNextBtn();
