...
manifest = [{
	src: 'pages/images/Topic01/T01P36/Mask_Group_11.png',
	id: '1'
}, ];

var audioPath = "pages/audio/Topic01/T01P36/T01P36";
var gItemAudioPath = ["pages/audio/Topic01/T01P36/T01P36_1", "pages/audio/Topic01/T01P36/T01P36_2"];
...
var updateContentArray = [{
	...
	show: "",
	hide: "",
	transcript: "Let’s practice identifying the types of shock. For each example, read the case summary and then select the type of shock the infant is experiencing."
}];
...
var popupSectionArray0 = [{
	...
	show: "",
	hide: "",
	transcript: "Here is some feedback on your response: The infant is most likely experiencing hypovolemic shock secondary to maternal hemorrhage.<br>Click Next to continue."
}, {
	time: "0",
	carry: "",
	event: "",
...
var popupSectionArray1 = [
	
	{
		...
		show: "",
		hide: "",
		transcript: "That is correct. The infant is most likely experiencing hypovolemic shock secondary to maternal hemorrhage.<br>Click Next to continue."
	}, {
		time: "0",
		carry: "",
		event: "",
...
$(document).ready(function() {
	...
	$("#ClsbackImg2").hide()
	$("#subTxt3").hide();
	var n = isInArray("M1L0T1P36", gCompPageArr);
	if (n == true) {
		enableNextBtn();
		// fnGlowNextBtn();
