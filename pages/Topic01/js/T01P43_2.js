...
glossaryFuncPageLevel();
    ...
    var audioPath = "pages/audio/Topic01/T01P43/T01P43_1";
    var updateContentArray = [
        {
            ...
            show: "",
            hide: "",
            transcript: 'The treatment of obstructive shock relates to the obstructive etiology.<br/> For a tension pneumothorax, treatment involves needle aspiration or chest tube insertion to evacuate the air.<br/> For cardiac tamponade, treatment involves pericardiocentesis to remove air or fluid.<br/>For ductal-dependent, left-outflow tract obstructive heart lesions, treatment involves initiation of a prostaglandin E1 infusion to establish and maintain patency of the ductus arteriosus.'
        },
        {
            time: "0.1",
            carry: "",
...
$(document).ready(function() {
    ...
    var n = isInArray("M1L0T1P43_2", gCompPageArr);
