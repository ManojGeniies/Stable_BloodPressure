...
manifest = [{
	src: 'pages/images/Topic01/T01P37/Mask_Group_11.png',
	id: '1'
}, ];

var audioPath = "pages/audio/Topic01/T01P37/undefined";
var gItemAudioPath = [
	"pages/audio/Topic01/T01P37/T01P37_1",
	 "pages/audio/Topic01/T01P37/T01P37_2"
];
...
var popupSectionArray0 = [{
	...
	show: "",
	hide: "",
	transcript: "Here is some feedback on your response: The infant is most likely experiencing cardiogenic shock secondary to an arrhythmia.<br>Click Next to continue. "
}, {
	time: "0",
	carry: "",
	event: "",
...
var popupSectionArray1 = [
	
	{
		...
		show: "",
		hide: "",
        transcript: "That is correct. The infant is most likely experiencing cardiogenic shock secondary to an arrhythmia.<br>Click Next to continue."
	}, {
		time: "0",
		carry: "",
		event: "",
...
$(document).ready(function() {
	...
	$("#ClsbackImg2").hide()
	$("#subTxt3").hide();
	var n = isInArray("M1L0T1P37", gCompPageArr);
	if (n == true) {
		enableNextBtn();
		// fnGlowNextBtn();
