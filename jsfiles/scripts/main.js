...
var physical_exam_signs_shock_MenuArr = ["M1L0T1P10", "M1L0T1P10_1", "M1L0T1P10_2", "M1L0T1P10_3"];
var physical_exam_signs_shock_MenuArr_length = 0;

var physical_exam_signs_shock2_MenuArr = ["M1L0T1P11", "M1L0T1P11_1", "M1L0T1P11_2", "M1L0T1P11_3","M1L0T1P11_4","M1L0T1P11_5"];
var physical_exam_signs_shock2_MenuArr_length = 0;


var shock_four_main_case_MenuArr = ["M1L0T1P35", "M1L0T1P35_1", "M1L0T1P35_2", "M1L0T1P35_3","M1L0T1P35_4"];
var shock_four_main_case_MenuArr_length = 0;

var shock_treatment_MenuArr = ["M1L0T1P43", "M1L0T1P43_1", "M1L0T1P43_2", "M1L0T1P43_3","M1L0T1P43_4"];
var shock_treatment_MenuArr_length = 0;
    ...
    switch (lCase) {
        ...
        case "NEXT":
            ...
            if (_getPreviousBookMarkPage != "") {
                ...
                // Physical exam for signs of shock start
                if (lPageId == "M1L0T1P10" || lPageId == "M1L0T1P10_1" || lPageId == "M1L0T1P10_2" || lPageId == "M1L0T1P10_3"){
                    console.log("Physical exam for signs of shock ",physical_exam_signs_shock_MenuArr_length,physical_exam_signs_shock_MenuArr.length);
                    if(physical_exam_signs_shock_MenuArr_length == physical_exam_signs_shock_MenuArr.length){
                        fnJumpToPageByID("M1L0T1P11");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P10_1") == -1){
                        fnJumpToPageByID("M1L0T1P10_1");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P10_2") == -1){
                        fnJumpToPageByID("M1L0T1P10_2");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P10_3") == -1){
                        fnJumpToPageByID("M1L0T1P10_3");
                        return;
                    }                    
                }
                // Physical exam for signs of shock end


                // Physical exam for signs of shock 2 start
                if (lPageId == "M1L0T1P11" || lPageId == "M1L0T1P11_1" || lPageId == "M1L0T1P11_2" || lPageId == "M1L0T1P11_3" || lPageId == "M1L0T1P11_4" || lPageId == "M1L0T1P11_5"){
                    console.log("Physical exam for signs of shock 2 ",physical_exam_signs_shock2_MenuArr_length,physical_exam_signs_shock2_MenuArr.length);
                    if(physical_exam_signs_shock2_MenuArr_length == physical_exam_signs_shock2_MenuArr.length){
                        fnJumpToPageByID("M1L0T1P12");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P11_1") == -1){
                        fnJumpToPageByID("M1L0T1P11_1");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P11_2") == -1){
                        fnJumpToPageByID("M1L0T1P11_2");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P11_3") == -1){
                        fnJumpToPageByID("M1L0T1P11_3");
                        return;
                    }                    
                    if (gCompPageArr.indexOf("M1L0T1P11_4") == -1){
                        fnJumpToPageByID("M1L0T1P11_4");
                        return;
                    }                    
                    if (gCompPageArr.indexOf("M1L0T1P11_5") == -1){
                        fnJumpToPageByID("M1L0T1P11_5");
                        return;
                    }                    
                }
                // Physical exam for signs of shock 2 end
                
                // Shock Four Main Causes start
                if (lPageId == "M1L0T1P35" || lPageId == "M1L0T1P35_1" || lPageId == "M1L0T1P35_2" || lPageId == "M1L0T1P35_3" || lPageId == "M1L0T1P35_4"){
                    console.log("Shock Four Main Causes ",shock_four_main_case_MenuArr_length,shock_four_main_case_MenuArr.length);
                    if(shock_four_main_case_MenuArr_length == shock_four_main_case_MenuArr.length){
                        fnJumpToPageByID("M1L0T1P36");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P35_1") == -1){
                        fnJumpToPageByID("M1L0T1P35_1");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P35_2") == -1){
                        fnJumpToPageByID("M1L0T1P35_2");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P35_3") == -1){
                        fnJumpToPageByID("M1L0T1P35_3");
                        return;
                    }                    
                    if (gCompPageArr.indexOf("M1L0T1P35_4") == -1){
                        fnJumpToPageByID("M1L0T1P35_4");
                        return;
                    }                     
                }
                // Shock Four Main Causes end

                 // Shock Treatment start
                 if (lPageId == "M1L0T1P43" || lPageId == "M1L0T1P43_1" || lPageId == "M1L0T1P43_2" || lPageId == "M1L0T1P43_3" || lPageId == "M1L0T1P43_4"){
                    console.log("Shock Treatment ",shock_treatment_MenuArr_length,shock_treatment_MenuArr.length);
                    if(shock_treatment_MenuArr_length == shock_treatment_MenuArr.length){
                        fnJumpToPageByID("M1L0T1P44");
                        return;
                    } 
                    if (gCompPageArr.indexOf("M1L0T1P43_1") == -1){
                        fnJumpToPageByID("M1L0T1P43_1");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P43_2") == -1){
                        fnJumpToPageByID("M1L0T1P43_2");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P43_3") == -1){
                        fnJumpToPageByID("M1L0T1P43_3");
                        return;
                    }                    
                    if (gCompPageArr.indexOf("M1L0T1P43_4") == -1){
